...
function TechnicalSheetCard(_a) {
    ...
    return (<react_native_1.View style={styles.card}>
      ...
      <react_native_1.View style={styles.canvasWrap}>
        {normalizedType === 'ring' ? (<RingDiagram sheet={sheet}/>) : normalizedType === 'necklace' || normalizedType === 'pendant' || normalizedType === 'chain' ? (<NecklaceDiagram sheet={sheet}/>) : normalizedType === 'bracelet' ? (<BraceletDiagram sheet={sheet}/>) : normalizedType === 'bangle' ? (<BangleDiagram sheet={sheet}/>) : normalizedType === 'earrings' ? (<EarringDiagram sheet={sheet}/>) : (<NecklaceDiagram sheet={sheet}/>)}
      </react_native_1.View>
