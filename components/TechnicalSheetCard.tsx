  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.subtitle}>
        CAD-style technical layout for {sheet.jewelryType || 'jewelry'}
      </Text>
      ...
      <View style={styles.canvasWrap}>
        <Svg width="100%" height={460} viewBox="0 0 800 920">
          ...
          <SvgText x="50" y="65" fontSize="24" fontWeight="700" fill="#111111">
            TOP VIEW
          </SvgText>

          <SvgText x="430" y="65" fontSize="24" fontWeight="700" fill="#111111">
            SIDE VIEW
          </SvgText>
          ...
          <SvgText x="98" y="92" fontSize="18" fill="#111111">
            A = {sheet.centerStoneDiameterMm || 0} mm
          </SvgText>

          <Line x1="96" y1="300" x2="60" y2="300" stroke="#111111" strokeWidth="2" />
          <Line x1="60" y1="152" x2="60" y2="308" stroke="#111111" strokeWidth="2" />
          <SvgText x="70" y="318" fontSize="18" fill="#111111">
            B = {sheet.bandWidthMm || 0} mm
          </SvgText>

          <SvgText x="110" y="355" fontSize="18" fill="#111111">
            Ring Size: {sheet.ringSize || '—'}
          </SvgText>
          ...
          <SvgText x="485" y="108" fontSize="18" fill="#111111">
            C = center stone
          </SvgText>

          <Line x1="455" y1="285" x2="455" y2="235" stroke="#111111" strokeWidth="2" />
          <Line x1="455" y1="235" x2="430" y2="235" stroke="#111111" strokeWidth="2" />
          <SvgText x="430" y="225" fontSize="18" fill="#111111">
            D = {sheet.prongCount || 0} prongs
          </SvgText>

          <SvgText x="515" y="355" fontSize="18" fill="#111111">
            Finish: {sheet.finishLevel || '—'}
          </SvgText>

          {/* Spec table */}
          <Rect x="40" y="410" width="700" height="450" rx="10" fill="#ffffff" stroke="#d5d5d5" />
          <SvgText x="60" y="445" fontSize="24" fontWeight="700" fill="#111111">
            SPECIFICATIONS
          </SvgText>
          ...
          {sheet.specRows.slice(0, 10).map((row, index) => {
            ...
            return (
              <React.Fragment key={`${row.label}-${index}`}>
                <SvgText x="60" y={y} fontSize="18" fontWeight="700" fill="#111111">
                  {row.label}
                </SvgText>
                <SvgText x="300" y={y} fontSize="18" fill="#333333">
                  {row.value}
                </SvgText>
              </React.Fragment>
            );
